...
class getLexikJwtAuthentication_KeyLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\RawKeyLoader((\dirname(__DIR__, 5).'/memonator_site/config/jwt/private.pem'), (\dirname(__DIR__, 5).'/memonator_site/config/jwt/public.pem'), 'meme');
    }
}
