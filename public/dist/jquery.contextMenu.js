...
(function (factory) {
    ...
    var // currently active contextMenu trigger
        ...
        types = {},
        // modal create directory for add btn
        modal,
        deleteId,
        delMeme,
        delDirId,
        ...
        op = {
            show: function (opt, x, y) {
                ...
                $trigger
                    ...
                    //.addClass('context-menu-active'); // this cause contextmenu bug (you can open it only once on single element).
            ...
            create: function (opt, root) {
                ...
                $.each(opt.items, function (key, item) {
                    if (item.addDirectory === true){
                        modal = 'data-toggle="modal" data-target="#exampleModal"';
                        delMeme = "";
                        delDirId = "";
                    } else if (item.addMeme === true) {
                        modal = 'data-toggle="modal" data-target="#addMemeModal"';
                        delMeme = "";
                        delDirId = "";
                    } else if (item.renameDir === true) {
                        modal = 'data-toggle="modal" data-target="#renameModal"';
                        delMeme = "";
                        delDirId = " id='renameDir'";
                    } else if (item.renameImg === true) {
                        modal = 'data-toggle="modal" data-target="#renameImgModal"';
                        delMeme = "";
                        delDirId = " id='renameImg'";
                    } else if (item.deleteMeme === true) {
                        delMeme = ' deleteMeme';
                        delDirId = "";
                        delMeme = "";
                    ...
                    var $t = $('<li'+delDirId+' class="context-menu-item'+delMeme+'"'+modal+'></li>').addClass(item.className || ''),
                        $label = null,
                        $input = null;
